...
- [MongoDB Requests](#mongodb-requests)
  ...
  - [Operations](#operations)
    ...
    - [distinct](#distinct)
    - [script](#script)
    - [Writing async Mongo scripts](#writing-async-mongo-scripts)
    - [Multiple queries in one script](#multiple-queries-in-one-script)
    - [Promise values inside returned objects](#promise-values-inside-returned-objects)
